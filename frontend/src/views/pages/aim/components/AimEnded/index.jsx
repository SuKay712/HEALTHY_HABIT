...
import { getTaskEnded } from "../../../../../api/aimAPI";
...
const AimEnded = (userID) => {
  ...
  const [aimEnded, setAimEnded] = useState("");
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const response = await getTaskEnded(params);
                ...
                >
                  ...
                  >
                    <Card.Body>
                      <Row>
                        <Col md={6}>
                          <strong>Tên:</strong> {aimEnded.name}
                        </Col>
                        <Col md={6}>
                          <strong>Mô tả:</strong> {aimEnded.description}
                        </Col>
                      </Row>
                      <Row>
                        <Col md={6}>
                          <strong>Phần thưởng:</strong> {aimEnded.prize}
                        </Col>
                        <Col md={6}>
                  ...
                  {aimEnded.tasksProgress.map((task, index) => (
                    <Row key={index}>
