        ...
        <div className="individual-container">
            {showAddForm && (
                <Modal onClickOutside={handleCloseAddForm}>
                    <AddPostForm handleAddLocalPost={handleAddLocalPost} handleCloseForm={handleCloseAddForm} />
                </Modal>
            )}
            <div className="individual-info-container">
                <div className="individual-background-container">
                    <img src={user.backgroundImage} alt="user background" className="individual-info-background" />
                    <Button onClick={onChangeBackground} className="individual-info-background-button">
                ...
                <div className="individual-info-persional-container">
                    <div className="position-relative">
                        <img src={user.avatar} alt="user avatar" className="individual-info-avatar" />
                        <Button onClick={onChangeAvatar} className="individual-info-avatar-button">
                    ...
                    <p className="individual-username">{user.displayName}</p>
                </div>
            </div>
            <div className="individual-new-post-container">
                <img alt="user avatar" src={user.avatar} className="individual-new-post-avatar" />
                <div className="individual-new-post-input-container">
                    ...
                    <div className="individual-new-post-button-container">
                        <Button icon={<FaRegImage />} className="individual-new-post-button" />
            ...
            <div className="individual-posts-container">
                {posts &&
                    posts.length > 0 &&
                    posts.map((post) => <SmallPost post={post} onUpdatePost={onUpdatePost} user={user} />)}
            </div>
        </div>
    );
}
